...
<html>
	<head>
		...
		<link href="../css/健康分析.css" rel="stylesheet">
	...
	<body>
		<div class="container">
			<div class="information" id="information_data">
				<div class="col-xs-4" style="color: orange">19岁</div>
				<div class="col-xs-4" style="color: orange">110.3斤</div>
				<div class="col-xs-4" style="color: orange">160cm</div>
			</div>
			<div class="information" id="information_text">
				<div class="col-xs-4">年龄</div>
				<div class="col-xs-4">当前体重</div>
				<div class="col-xs-4">身高（cm）</div>
			</div>
			<div class="BMI">
				<div class="level">
					<div class="col-xs-3"></div>
					<div class="col-xs-6">您的--<span id="BMI" style="color: orange">BMI 21.6</span>正常</div>
					<div class="col-xs-3">
						<button class="icon" onclick="window.location.href='BMI.html'"><i class="fa fa-question-circle" style="color: orange"></i></button>
					</div>
				</div>
				<div class="introduction">BMI:身体质量指数（BMI）是目前国际上常量的衡量人体胖瘦程度以及是否是否健康的一个标准</div>
			</div>
			<div class="people">
				<img class="image" src="../img/people.png">
			</div>
			<div class="status">
			...
			<div class="bottom">
				<div id="bottom_icon">
					...
					<div class="col-xs-3">
						<button class="icon" onclick="window.location.href='个人中心.html'"><i class="fa fa-user"></i></button>
					</div>
				</div>
				<div id="bottom_text">
					<div class="col-xs-3">
					...
					<div class="col-xs-3">
						<button class="icon" onclick="window.location.href='个人中心.html'">个人中心</button>
					</div>
				</div>
			</div>
