...
?>
			<!-- <div class="information" id="information_data">
				<div class="col-xs-4" style="color: orange">21</div>
			...
			<div class="bottom">
				<div id="bottom_icon">
					...
					<div class="col-xs-3">
						<button class="icon" onclick="window.location.href='center.html'"><i class="fa fa-user"></i></button>
					</div>
				</div>
				<div id="bottom_text">
					<div class="col-xs-3">
					...
					<div class="col-xs-3">
						<button class="icon" onclick="window.location.href='center.html'">个人中心</button>
					</div>
				</div>
			</div>
